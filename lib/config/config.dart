...
class Config {
  static const appName = 'Westbengal Jobs';
  static const supportEmail = 'ashifiqbal12312@gmail.com';
  static const privacyPolicyUrl = 'https://job-india.co.in/privacy-policy';
  ...
  //languages
  static const List<String> languages = ['English', 'Spanish', 'Arabic'];
